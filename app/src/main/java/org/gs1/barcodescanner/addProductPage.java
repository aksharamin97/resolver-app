    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    body1.put("command", "get_response_uri_data");
                    body1.put("session_id", sid);
                    body1.put("uri_request_id", new_product_id);
                ...
                client.newCall(request1).enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        if (response.isSuccessful()){
                            ...
                            System.out.println("get_response_uri_data:   " + jsonString1);

                            addProductPage.this.runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast toast = Toast.makeText(getApplicationContext(),"Response URI Successful", Toast.LENGTH_SHORT);
                                    toast.show();
                                }
                            });
//                            else{
...
/////////////////////////////////////////////////////////////////////////////////////////
                ...
                try {
                    ...
                    body3.put("uri_request_id", new_product_id.toString());
